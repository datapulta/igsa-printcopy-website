...
const categories = [
  {
    ...
    description: "¡Materializa tus ideas al instante! Ve, toca y prueba tus diseños antes de la producción. Optimiza tiempo, reduce costos y acelera el lanzamiento de tus productos.",
    icon: "🚀",
  },
  {
    title: "Impresión 2D",
    description: "Colores vibrantes y acabados de alta calidad. Imprimimos desde planos y pósters hasta materiales publicitarios personalizados. ¡Máximo impacto!",
    icon: "🎨",
  },
  {
    title: "Servicios de diseño",
    description: "Diseños que comunican y venden. Convertimos tus ideas en propuestas visuales atractivas, funcionales y listas para impresión.",
    icon: "✨",
  },
  {
    title: "Posprocesamiento",
    description: "Acabados que marcan la diferencia. Ofrecemos pulido, pintado, ensamblado y protección final para una presentación impecable.",
    icon: "💎",
  },
]
...
const services = [
  ...
  },
  {
    ...
    description: "Imprimimos pósters, banners, lonas y gráficos de gran tamaño con la máxima calidad y colores vibrantes para publicidad exterior.",
  ...
  {
    title: "Letreros 3D",
    description: "Fabricamos letras corpóreas de diversos materiales con o sin iluminación para una presencia sofisticada y memorable.",
  ...
  {
    title: "Señalética",
    description: "Guiamos, informamos y regulamos con letreros y directorios funcionales y estéticos para corporativos y espacios públicos.",
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
            <AnimateOnScroll>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6 tracking-tight">
                Qué podemos hacer{" "}
                <span className="gradient-text">por ti</span>
              </h1>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-background/95 via-background/70 to-background/30 flex items-center">
                  <div className="p-8 md:p-14">
                    <h2 className="text-3xl md:text-5xl font-bold text-foreground leading-tight tracking-tight">
                      <span className="gradient-text">CORTE LÁSER,</span>
                      <br />
                      VOLANTES,
                      <br />
                      FOLLETOS.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {services.map((service, index) => (
                <AnimateOnScroll key={index} delay={index * 0.08}>
                  <div className="group flex flex-col md:flex-row gap-0 rounded-2xl glass-card premium-card overflow-hidden h-full">
                    {/* Image */}
                    ...
                    <div className="flex flex-col justify-center p-6">
                      ...
                      <Link
                        href="/contacto"
                        className="group/btn inline-flex items-center gap-2 px-5 py-2 text-xs font-semibold text-foreground rounded-full border border-white/[0.1] bg-white/[0.03] hover:bg-primary/10 hover:border-primary/30 hover:text-primary transition-all duration-300 w-fit"
                      >
