      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-sm font-semibold text-foreground mb-4">Encuéntrenos en</h3>
              ...
              {locations.map((location, index) => (
                <div key={index} className="space-y-2">
                  ...
                  >
                    ...
                    <span className="underline group-hover:no-underline">{location.address}</span>
                  </a>
                  {location.reference && (
                    <p className="text-xs text-muted-foreground ml-6">*Referencia: {location.reference}</p>
                  )}
                  <a 
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-4">Menú</h3>
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground mb-4">Contáctanos</h3>
