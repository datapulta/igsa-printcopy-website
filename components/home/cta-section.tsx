      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <AnimateOnScroll direction="scale">
          <div className="relative rounded-[2.5rem] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_50%,rgba(0,63,127,0.08),transparent_50%)]" />
            ...
            <div className="relative px-8 py-20 md:px-16 md:py-28 text-center">
              ...
              <p className="text-lg text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
                Desde una tarjeta de presentación hasta una lona gigante, estamos listos para hacerlo realidad.
              </p>
